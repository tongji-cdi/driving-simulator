...
namespace NWH.VehiclePhysics2.Effects
{
    ...
    public class SurfaceParticleSystem
    {
        ...
        /// </summary>
        [Tooltip("    Current particle count in the scene.")]
        ...
        public void Initialize(VehicleController vc, WheelComponent wheelComponent)
        {
            ...
            if (vc.groundDetection.groundDetectionPreset.particlePrefab != null)
            {
                ...
                particlePrefab.transform.position = wheelComponent.wheelController.wheel.worldPosition
                                                    ...
                                                    (wheelComponent.wheelController.radius * 0.5f);
        ...
        private void UpdateParticles()
        {
            ...
            if (surfacePreset.particleType == SurfacePreset.ParticleType.Smoke)
            {
                ...
                {
                    float latEmission = _wheelComponent.HasLateralSlip ? lateralSlipCoeff : 0;
                    float lngEmission = _wheelComponent.HasLongitudinalSlip ? longitudinalSlipCoeff : 0;
        ...
        private void UpdateChunks()
        {
            ...
            else
            {
                ...
                _emissionModule.rateOverTime = 0;
                _emissionModule.rateOverDistance = (_wheelComponent.NormalizedLongitudinalSlip * 0.7f +
                                                    _wheelComponent.NormalizedLateralSlip * 0.3f)

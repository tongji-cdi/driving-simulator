...
/************************************************************************************
基于oculus SDK 提供的 OVRInputModule 进行修改。
...
namespace UnityEngine.EventSystems
{
    ...
    public class MRInputModule : PointerInputModule
    {
        ...
        private void ProcessMousePress(MouseButtonEventData data)
        {
            ...
            if(m_MRScreenInput != null)
            {
                if (m_MRScreenInput.PressedThisFrame())
                {
                    ...
                    pointerEvent.pressPosition = m_MRScreenInput.GetPosition();
        ...
        private void ProcessMRScreenEvent()
        {
            var raycast = FindFirstRaycast(m_RaycastResultCache);
            Debug.Log("current: " + raycast.gameObject);
...
#region PointerEventData pool
        ...
        virtual protected MouseState GetGazePointerData()
        {
            ...
            MRScreenRaycaster mrTouchUIRaycaster = raycast.module as MRScreenRaycaster;
            if (mrTouchUIRaycaster)
            {
                Debug.Log("mrTouchUIRaycaster: " + mrTouchUIRaycaster);
